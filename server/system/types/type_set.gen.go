...
// Walk iterates through every slice item and calls w(Order) err
//
// This function is auto-generated.
func (set OrderSet) Walk(w func(*Order) error) (err error) {
	for i := range set {
		if err = w(set[i]); err != nil {
			return
		}
...
// Filter iterates through every slice item, calls f(Order) (bool, err) and return filtered slice
//
// This function is auto-generated.
func (set OrderSet) Filter(f func(*Order) (bool, error)) (out OrderSet, err error) {
	var ok bool
	out = OrderSet{}
	for i := range set {
		if ok, err = f(set[i]); err != nil {
...
//
// This function is auto-generated.
func (set OrderSet) FindByID(ID uint64) *Order {
	for i := range set {
		if set[i].ID == ID {
			return set[i]
		}
...
//
// This function is auto-generated.
func (set OrderSet) IDs() (IDs []uint64) {
	IDs = make([]uint64, len(set))
